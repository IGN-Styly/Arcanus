...
public class RitualRenderer implements BlockEntityRenderer<RitualBlockEntity> {
    ...
    @Override
    public void render(RitualBlockEntity pedestalTile, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
    ...
    private void renderItem(ItemStack itemStack, Vec3 offset, float yRot, RitualBlockEntity pedestalTile, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
        poseStack.pushPose();
